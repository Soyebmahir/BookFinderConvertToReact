      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1">
            {[...Array(book?.star).keys()]?.map((star) => (
              <img key={star} src={starImg} />
            ))}
        ...
        <div className="flex items-center gap-3 text-xs lg:text-sm">
          ...
          <button
            className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md bg-[#1C4336]/[14%] py-1.5 text-[#1C4336] transition-all hover:bg-[#1C4336]/[24%] lg:py-1.5 ${
              book.isFavourite &&
              "bg-[#DC2954]/[14%] hover:bg-[#DC2954]/[24%] text-[#DC2954] "
            }`}
          ...
          >
            {/* <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className={`h-5 w-5 ${book.isFavourite ? "text-pink-900" : ""}`}
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <span className={`${book.isFavourite ? "text-[#DC2954]" : ""}`}>
              Favourite
            </span>
          </button>
        </div>
